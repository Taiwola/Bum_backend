...
import { create_user, get_all_user, get_one_user, get_one_by_email, update_user, delete_user, getAgencyById, get_team_members, getOneSubAccount, get_subacc_team_members } from '../service';
...
export const getSubAccTeamMembers = async (req: Request, res: Response) => {
    const Id = req.params.Id;
    ...
    const teamMembers = await get_subacc_team_members(Id);
